...
const CalendarCollectionsManager: React.FC<CalendarCollectionsManagerProps> = ({
  ...
  const isCompactOptions = containerWidth > 0 && containerWidth < 1024;
  ...
  const calendarOptions = (
    <div className="flex flex-col gap-3">
      <div className="space-y-2">
        {isCompactOptions && <div className="text-xs font-medium text-neutral-500 dark:text-neutral-400">Affichage</div>}
      ...
      {(viewMode === 'week' || viewMode === 'day') && (
        <div className="space-y-2">
          <div className="text-xs text-neutral-400">Déplacement</div>
        ...
        <div className="flex min-w-0 flex-col gap-4 lg:flex-row lg:items-center lg:justify-between md:flex-wrap lg:pl-[50px]">
          ...
          <div className="flex w-full flex-col gap-3 lg:w-auto lg:flex-row lg:items-center md:flex-wrap">
            ...
            <div
              ...
              className="flex w-full flex-wrap items-start gap-3 lg:w-auto lg:items-center"
            >
              {isCompactOptions ? (
                <Popover open={showOptions} onOpenChange={setShowOptions}>
                  ...
                  <PopoverContent
                    align="start"
                    sideOffset={8}
                    className="w-[min(90vw,26rem)] rounded-xl border border-black/10 dark:border-white/10 bg-background dark:bg-neutral-950/95 p-4 shadow-xl backdrop-blur"
                  >
                    <div className="space-y-3">
                      <div>
                        <div className="text-sm font-semibold text-neutral-700 dark:text-neutral-100">Options du calendrier</div>
                        <div className="text-xs text-neutral-500 dark:text-neutral-400">Choisis l’affichage et le mode de déplacement.</div>
                      </div>
                      {calendarOptions}
                    </div>
                  </PopoverContent>
